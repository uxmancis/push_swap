...
/*   Updated: 2023/05/06 20:04:43 by uxmancis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int cheapst_org_stack_b(int *stack_b, int len_b, int travl_nb, int indx_nxt_smallst)
{
   ...
   printf("arr2_numof_moves[0] = %d\n", arr2_numof_moves[0]);
   printf("arr2_numof_moves[1] = %d\n", arr2_numof_moves[1]);
   printf("arr2_numof_moves[2] = %d\n", arr2_numof_moves[2]);
   printf("arr2_numof_moves[3] = %d\n", arr2_numof_moves[3]);
   printf("arr2_numof_moves[4] = %d\n", arr2_numof_moves[4]);
   printf("arr2_numof_moves[5] = %d\n", arr2_numof_moves[5]);
   return (0);
}
